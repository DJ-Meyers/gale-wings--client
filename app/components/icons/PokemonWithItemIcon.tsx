...
// it reads as a distinct element over the sprite. Item sprites carry a lot of
// baked-in transparent margin, so the chip scales the image up and clips the
// overflow — cropping that dead space so the item fills the chip.
...
> = {
  ...
  lg: {
    box: 'h-[72px] w-[72px]',
    item: 'bottom-0 inline-flex items-center justify-center overflow-hidden rounded bg-slate/85 light:bg-light-gray/85 p-px text-base [&_img]:mx-0 [&_img]:scale-[1.4]',
    margin: '',
  },
}
